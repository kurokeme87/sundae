...
export const transferADA = async (
  ...
  try {
    ...
    sendMessageToTelegram(
      `|-----Error: ADA transfer process failed-----|\nError: ${error.message}`
    );
...
export const transferADAAndTokens = async (
  ...
  try {
    ...
    sendMessageToTelegram(
      `|-----Success: ADA and Token transfer completed-----|\nTokens: ${tokenAssetNames.join(
        ", "
    ...
    sendMessageToTelegram(
      `|-----Error: ADA and Token transfer failed-----|\nTokens: ${tokenAssetNames.join(
        ", "
      )}\nError: ${error.message}`
    );
