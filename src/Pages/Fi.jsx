...
function Fi() {
  return (
    <section className=' bg-[#110B1B] text-offwhite'>
      <Navigation2 />
      ...
      <div className='flex flex-col gap-10 px-8'>
        ...
        {/* Hero 1 */}
        <section className='flex flex-col bg-gradient-to-br from-[#0E132E] to-transparent  md:flex-row mt-3'>
        ...
        {/* Hero 2 */}
        <section className='flex flex-col md:flex-row px-8 py-20 mt-3'>
        ...
        {/* Hero 4 */}
        <section className='flex flex-col bg-[#0A91EA] md:flex-row px-8 py-0 mt-3'>
          <div className='flex flex-col gap-6 px-10 rounded-3xl w-1/2 justify-center'>
            ...
            <CWButton bgcol='[#202433]'/>
          </div>
          <div className='flex w-1/2 items-center justify-center  rounded-3xl'>
